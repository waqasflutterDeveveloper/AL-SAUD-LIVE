...
import Tabs from './Tabs/PaymentTab';
...
const PaymentScreen = ({route, navigation}) => {
  ...
  const [indexTab, setIndex] = useState(index);
  // useEffect(() => {
  //   if (item) {
  //     console.log(item?.cheque_status_code, 'aaaammmm');
  ...
  //     ) {
  //       setIndex(1);
  //       console.log(item?.cheque_status_code, 'cheque_status_code up');
  //     } else {
  //       setIndex(1);
  //       console.log(item?.cheque_status_code, 'cheque_status_code down');
  //     }
  //   }
  // }, [item]);
  return (
    <SafeAreaView
      ...
      />
      <Header back title={translations['Payments']} />
      ...
      <Tabs
        ...
        hasLegalCase={route?.params?.hasLegalCase}
      />
