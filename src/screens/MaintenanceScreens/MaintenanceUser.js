...
import MaintainenceuserTabs from '../Tabs/MaintainenceuserTabs';
import MaintenanceNavDesign from '../../Components/Navigation/MaintenanceNavDesign';
const {width} = Dimensions.get('screen');

const MaintenanceUser = ({route, navigation}) => {
  return (
    <SafeAreaView
      style={{
      ...
      />
      <Header back title={'Maintainence '} />
      <View style={style.down} />
      <MaintainenceuserTabs index={1} />
